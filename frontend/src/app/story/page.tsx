...
export const metadata: Metadata = {
  title: "The story — MAiSTRO",
  description:
    "How eight students at Western Cyber Society built an LSTM that composes classical piano.",
};
  ...
  return (
    <div>
      ...
      <p className="mt-4 max-w-[65ch] text-muted-foreground">
        ...
        Western Cyber Society. The story so far, in the order we lived it. For where the project
        went next, read{" "}
      ...
      <section className="mt-16">
        ...
        <p className="mt-12 max-w-[70ch] text-muted-foreground">
          By the way, the model only outputs MIDI files during generation, and to turn one into
          something audible we manually applied a piano soundfont. Generated pieces now play
          straight in the browser, no soundfont required. With the remaining Google Colab credits
          we had, we trained the model for a final 50 epochs, that&apos;s the last clip above. This
          is something I would genuinely listen to if I was trying to zone in during a study
      ...
      <section className="mt-16 mb-4">
        <h2 className="font-display text-3xl text-foreground">Then we kept going</h2>
        <p className="mt-5 max-w-[70ch] text-muted-foreground">
          Everything above is where the project stood when the team finished it. Since then the
          decoder has been rebuilt, two more architectures joined the model, and the whole thing
          became something you can steer rather than re-roll.{" "}
          <Link href="/how-it-works" className="text-brass underline underline-offset-2">
            How it works
          </Link>{" "}
          covers that, with the measurements. Or skip the reading and{" "}
